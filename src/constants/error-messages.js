...
export const ERROR_MESSAGES = {
  ...
  GAME_TAG_RULES_FAILED: 'errors.games.tag_rules_failed',
  ...
  TAG_IN_USE: 'errors.tags.in_use',
  TAG_NAME_TAKEN: 'errors.tags.name_taken',
  TAG_TYPE_NOT_FOUND: 'errors.tags.type_not_found',
